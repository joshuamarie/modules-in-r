...
::: {.callout-warning}
The prefix `../` is quite a solution, indeed, however, using too many levels (e.g., `../../../`) can make your eye sore, and potentially makes your code a little bit harder to understand and maintain. If you find yourself going up many levels, consider reorganizing your folder structure or using absolute paths from the project root.
:::
...
And imagine you are in `script1.r` under `submodule2/subsubmodule1`. Is it possible to get `script2.r` under `submodule1/`? If yes, how? 
