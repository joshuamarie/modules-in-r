...
Then write the following unit tests below. Else, do the following steps below. Let us test both `module/statistics/models/linear.r` and `module/statistics/models/logistic.r`, for example:
